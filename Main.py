...
class Main:
    ...
    def sim_pi(self):
       ...
       # maze.matrix[3][2].walls = helper.split_walls('0010')
       ...
       # maze.matrix[3][3].walls = helper.split_walls('0101')
       # maze.matrix[2][3].walls = helper.split_walls('0011')
       # maze.matrix[1][3].walls = helper.split_walls('0011')
       # maze.matrix[0][3].walls = helper.split_walls('1010')
       # maze.matrix[0][4].walls = helper.split_walls('1100')
       # maze.matrix[0][5].walls = helper.split_walls('1101')
